 ...
 * @since 1.0.0
 */
class ColorTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_prime.color';
		parent::__construct('#__prime_colors', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_prime.color.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_prime/access.xml',
				"/access/section[@name='color']/"
			);
			$default_actions = Access::getAssetRules('com_prime.color.' . $array['id'])->getData();
			$array_jaccess   = array();
