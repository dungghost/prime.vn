 ...
 * @since 1.0.0
 */
class SizeTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_prime.size';
		parent::__construct('#__prime_sizes', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_prime.size.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_prime/access.xml',
				"/access/section[@name='size']/"
			);
			$default_actions = Access::getAssetRules('com_prime.size.' . $array['id'])->getData();
			$array_jaccess   = array();
