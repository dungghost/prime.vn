...
namespace Prime\Component\Prime\Administrator\Field;
 ...
 * @since  1.0.0
 */
class TileGroutColorField extends \Joomla\CMS\Form\FormField
{
	/**
	...
	protected function getInput()
	{
		...
		$db->setQuery("SELECT id, groutcolor  FROM #__prime_groutcolors
");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->groutcolor));
		}
