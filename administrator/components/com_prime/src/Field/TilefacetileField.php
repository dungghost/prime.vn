 ...
 * @since  1.0.0
 */
class TilefacetileField extends \Joomla\CMS\Form\FormField
{
	/**
	...
	protected function getInput()
	{
		...
		$db->setQuery("SELECT id, face  FROM #__prime_faces
");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->face));
		}
