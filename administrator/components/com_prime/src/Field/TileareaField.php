 ...
 * @since  1.0.0
 */
class TileareaField extends \Joomla\CMS\Form\FormField
{
	/**
	...
	protected function getInput()
	{
		...
		$db->setQuery("SELECT id, area  FROM #__prime_areas
");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->area));
		}
