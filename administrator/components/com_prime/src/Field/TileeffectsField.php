 ...
 * @since  1.0.0
 */
class TileeffectsField extends \Joomla\CMS\Form\FormField
{
	/**
	...
	protected function getInput()
	{
		...
		$db->setQuery("SELECT id, effect FROM #__prime_effects");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->effect));
		}
