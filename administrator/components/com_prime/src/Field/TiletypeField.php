 ...
 * @since  1.0.0
 */
class TiletypeField extends \Joomla\CMS\Form\FormField
{
	/**
	...
	protected function getInput()
	{
		...
		$db->setQuery("SELECT id, type  FROM #__prime_types");
		...
		{
			$options[] = HTMLHelper::_('select.option', $result->id, Text::_($result->type));
		}
