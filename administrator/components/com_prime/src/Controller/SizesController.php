...
{
	/**
	 * Method to clone existing Sizes
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_prime&view=sizes');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Size', $prefix = 'Administrator', $config = array())
	{
