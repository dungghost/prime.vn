...
{
	/**
	 * Method to clone existing Designs
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_prime&view=designs');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Design', $prefix = 'Administrator', $config = array())
	{
