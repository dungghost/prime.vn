...
{
	/**
	 * Method to clone existing Brands
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_prime&view=brands');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Brand', $prefix = 'Administrator', $config = array())
	{
