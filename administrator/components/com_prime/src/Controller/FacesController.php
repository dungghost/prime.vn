...
/**
 * Faces list controller class.
 *
 * @since  1.0.0
 */
class FacesController extends AdminController
{
	/**
	 * Method to clone existing Faces
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_prime&view=faces');
	}
	 ...
	 * @since   1.0.0
	 */
	public function getModel($name = 'Face', $prefix = 'Administrator', $config = array())
	{
