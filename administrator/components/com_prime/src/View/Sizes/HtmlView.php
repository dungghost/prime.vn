...
namespace Prime\Component\Prime\Administrator\View\Sizes;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_PRIME_TITLE_SIZES'), "jcc fa-expand");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Sizes';
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_prime&view=sizes');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`size`' => Text::_('COM_PRIME_SIZES_SIZE'),
			'a.`group`' => Text::_('COM_PRIME_SIZES_GROUP'),
		);
	}
