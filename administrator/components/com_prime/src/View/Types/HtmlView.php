...
namespace Prime\Component\Prime\Administrator\View\Types;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_PRIME_TITLE_TYPES'), "jcc fa-sitemap");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Types';
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_prime&view=types');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`type`' => Text::_('COM_PRIME_TYPES_TYPE'),
