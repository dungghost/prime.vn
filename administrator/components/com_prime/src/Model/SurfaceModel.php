...
class SurfaceModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.surface';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Surface', $prefix = 'Administrator', $config = array())
	{
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.surface.data', array());
	...
	/**
	 * Method to duplicate an Surface
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_surfaces');
				$max             = $db->loadResult();
