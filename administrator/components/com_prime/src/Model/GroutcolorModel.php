 ...
 * @since  1.0.0
 */
class GroutcolorModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.groutcolor';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Groutcolor', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.groutcolor.data', array());
	...
	/**
	 * Method to duplicate an Groutcolor
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_groutcolors');
				$max             = $db->loadResult();
