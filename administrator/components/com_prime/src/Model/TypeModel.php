...
class TypeModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.type';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Type', $prefix = 'Administrator', $config = array())
	{
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.type.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_types');
				$max             = $db->loadResult();
