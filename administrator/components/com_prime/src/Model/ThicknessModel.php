...
class ThicknessModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.thickness';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Thickness', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.thickness.data', array());
	...
	/**
	 * Method to duplicate an Thickness
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_thickness');
				$max             = $db->loadResult();
