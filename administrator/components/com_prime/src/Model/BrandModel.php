...
class BrandModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.brand';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Brand', $prefix = 'Administrator', $config = array())
	{
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.brand.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_brands');
				$max             = $db->loadResult();
