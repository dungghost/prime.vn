...
class AreaModel extends AdminModel
{
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.area';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Area', $prefix = 'Administrator', $config = array())
	{
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.area.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_areas');
				$max             = $db->loadResult();
