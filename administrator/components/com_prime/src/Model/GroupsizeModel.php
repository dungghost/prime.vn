 ...
 * @since  1.0.0
 */
class GroupsizeModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_prime.groupsize';
	 ...
	 * @since   1.0.0
	 */
	public function getTable($type = 'Groupsize', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_prime.edit.groupsize.data', array());
	...
	/**
	 * Method to duplicate an Groupsize
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__prime_group_size');
				$max             = $db->loadResult();
